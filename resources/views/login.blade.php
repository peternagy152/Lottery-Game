...
<li class="menu-item">
    <a href="{{ route('RReg') }}" class="link-term mercado-item-title">Register</a>
</li>
                ...
                <div class=" main-content-area">
                    <div class="wrap-login-item ">						
                        <div class="login-form form-item form-stl">
                            <form name="frm-login" action="/authenticate" method="POST">
                                @csrf
                                ...
                                <fieldset class="wrap-input">
                                    ...
                                    <a class="link-function left-position"  title="Forgotten password?">Forgotten password?</a>
                                </fieldset>
